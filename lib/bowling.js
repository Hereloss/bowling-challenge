class Bowling {
  ...
  myRoll(number) {
    ...
    else if (this.turn === 10 && number + this.bowls[this.turn][0] === 10 && this.roll === 2)
      {this.roll = 3}
  ...
  stillRolling() {
    ...
    {return true}
    else if (this.turn === 10 && this.bowls['10'][0] === 10 && this.roll === 2)
    {return true}
    else if (this.turn === 10 && this.bowls['10'][0] < 10 && this.roll === 2)
    {return true}
    else if (this.turn == 10 && this.bowls['10'][0] + this.bowls['10'][1] === 10 && this.roll === 3 && this.bowls['10'].length < 3)
    {return true}
    else if (this.turn == 10 && this.bowls['10'][0] === 10 && this.roll === 3 && this.bowls['10'].length < 3)
    {return true}
    else return false
  }
